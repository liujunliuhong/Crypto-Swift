...
extension Crypto.RIPEMD160 {
    ...
    public static func hash(message: String?) -> Data? {
        ...
        return Crypto.RIPEMD160.hash(message: data)
    }
}
...
extension Crypto.RIPEMD160 {
    ...
    public static func hmac(key: Data, message: String) -> Data {
        return Crypto.RIPEMD160.hmac(key: key, message: message.data(using: .utf8)!)
    }
    
    public static func hmac(key: String, message: String) -> Data {
        return Crypto.RIPEMD160.hmac(key: key.data(using: .utf8)!, message: message)
    }
}
